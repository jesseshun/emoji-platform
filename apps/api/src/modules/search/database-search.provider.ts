...
/**
 * Default search provider for Phase 6A.
 *
 * Preserves the existing database search behavior exactly (emoji-only results,
 * locale-aware matching, published-only, pagination, and search-log recording).
 * Moving this logic into a provider lets SearchService switch implementations

    ...
    <section className="mt-8">
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
        {display.map((emoji) => (
          <div
            key={emoji.id}
            className="rounded-[8px] border border-border-subtle bg-surface p-3 transition-all duration-fast hover:-translate-y-0.5 hover:border-border-strong hover:shadow-sm"
          >

      ...
      <div className="grid grid-cols-1 gap-3 md:grid-cols-2 lg:grid-cols-3">
        {display.map((topic) => (
          <Link
            ...
            className="group rounded-[8px] border border-border-subtle bg-surface p-4 transition-all duration-fast hover:border-border-strong hover:shadow-sm focus-visible:outline-none"
          >
